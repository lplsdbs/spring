...
public class RedisCluster {
    ...
    static {
        ...
        // 添加节点
        hostAndPortsSet.add(new HostAndPort("192.168.1.8", 6379));
        hostAndPortsSet.add(new HostAndPort("192.168.1.8", 6380));
        hostAndPortsSet.add(new HostAndPort("192.168.1.8", 6381));
        hostAndPortsSet.add(new HostAndPort("192.168.1.8", 6382));
        hostAndPortsSet.add(new HostAndPort("192.168.1.8", 6383));
        hostAndPortsSet.add(new HostAndPort("192.168.1.8", 6384));
