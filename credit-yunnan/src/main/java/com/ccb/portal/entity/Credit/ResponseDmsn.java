...
public class ResponseDmsn {

    private String dmsn_type;

    private String dmsn_value;

    private String dmsn_max_value;
    ...
    public String getDmsn_max_value() {
        return dmsn_max_value;
    }

    public void setDmsn_max_value(String dmsn_max_value) {
        this.dmsn_max_value = dmsn_max_value;
    }
}
