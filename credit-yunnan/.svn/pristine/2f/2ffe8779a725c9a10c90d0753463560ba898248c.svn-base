...
//        }
        ...
        logger.info(url+"返回的JSON数据["+result+"]");
        return result;

    }

    //http
    public static String Post(String url, String para,Map<String,String>head)throws Exception{
...
//        }
        logger.info(url+"返回的JSON数据["+response+"]");
        return response;
    }
    public static void main(String[] args) {
        ...
        try {
            ...
            String userinfjson=Get(usertemp);
